    ...
    <S.Wrapper>
      <S.ContentContainer>
        <S.Copy>
          ...
          Ele é um profissional <strong>altamente versátil,</strong> com foco em{" "}
          <strong>acessibilidade,</strong> ética e utilizando de uma{" "}
          ...
          especializado em <strong>Front-End,</strong> e com as tecnologias mais
          recentes do mercado. Aliado a habilidades de{" "}
          <strong>UX/UI Design,</strong> ele é capaz de conduzir um projeto
          digital desde sua concepção até sua implementação em código,
          resultando em{" "}
          <strong> sites responsivos, rápidos e que trazem resultados.</strong>
        </S.Copy>
        <S.ImageWrapper>
          <Image
